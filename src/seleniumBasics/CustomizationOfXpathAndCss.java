...
public class CustomizationOfXpathAndCss {
	// Xpath:
			// Absolute Xpath:
...
//					aria-label="Search" xpath="1">
	...
	public static void main(String[] args) {
		...
		WebElement offer1 = driver.findElement(By.xpath("/html/body/div[2]/table/tbody/tr/td[2]/table/tbody/"
				+ "tr[4]/td/table/tbody/tr/td[2]/table/tbody/tr[2]/td[1]/table[1]/tbody/tr[3]/td/table/"
				+ "tbody/tr[1]/td[1]/font"));
		String offer1Txt = offer1.getText();
		System.out.println(offer1Txt);
		
		String signInInfoTxt = driver.findElement(By.cssSelector("body > div:nth-child(5) > table > tbody > tr > "
				+ "td:nth-child(2) > table > tbody > tr:nth-child(4) > td > table > tbody > tr > "
				+ "td:nth-child(2) > table > tbody > tr:nth-child(2) > td:nth-child(3) > form > table >"
				+ " tbody > tr:nth-child(4) > td > table > tbody > tr:nth-child(1) > td > font")).getText();
		System.out.println(signInInfoTxt);
		
		
		driver.findElement(By.xpath("//span[contains(text(),'5 ways')][@class='a-truncate-cut'][aria-hidden='true']"));
		
		driver.close();
	}
	
	// Assignment: any application -> 10 elements -> xpath/css selector in all discussed strategy
